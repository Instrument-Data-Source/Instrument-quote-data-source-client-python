...
class InstrumentApi(object):
    ...
    def api_instrument_instrument_str_delete(self, instrument_str, **kwargs):  # noqa: E501
        """Delete instrument  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_instrument_instrument_str_delete(instrument_str, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str instrument_str: Instrument Id or Name (required)
        :return: str
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_instrument_instrument_str_delete_with_http_info(instrument_str, **kwargs)  # noqa: E501
        else:
            (data) = self.api_instrument_instrument_str_delete_with_http_info(instrument_str, **kwargs)  # noqa: E501
            return data

    def api_instrument_instrument_str_delete_with_http_info(self, instrument_str, **kwargs):  # noqa: E501
        """Delete instrument  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_instrument_instrument_str_delete_with_http_info(instrument_str, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_instrument_instrument_str_delete" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('instrument_str' not in params or
            ...
            raise ValueError("Missing the required parameter `instrument_str` when calling `api_instrument_instrument_str_delete`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/Instrument/{instrumentStr}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api_instrument_instrument_str_get(self, instrument_str, **kwargs):  # noqa: E501
        """Get Instrument by Id or Code  # noqa: E501
    ...
    def api_instrument_post(self, **kwargs):  # noqa: E501
        """Create new Instrument  # noqa: E501

        Sample request:                    POST /api/instrument      {         \"Name\":\"EUR vs USD\",         \"Code\":\"EURUSD\",         \"TypeId\":1,         \"PriceDecimalLen\": 5         \"VolumeDecimalLen\": 2      }  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
